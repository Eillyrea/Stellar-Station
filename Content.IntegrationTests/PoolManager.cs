...
public sealed class ContentPoolManager : PoolManager<TestPair>
{
    ...
    public override void Startup(params Assembly[] extraAssemblies)
    {
        ...
        var shared = extraAssemblies
                ...
                .Append(typeof(Stellar.Shared.Entry.EntryPoint).Assembly) // Stellar
                .Append(typeof(PoolManager).Assembly)
                .ToArray();

        Startup([typeof(Client.Entry.EntryPoint).Assembly, typeof(Stellar.Client.Entry.EntryPoint).Assembly], // Stellar
            [typeof(Server.Entry.EntryPoint).Assembly, typeof(Stellar.Server.Entry.EntryPoint).Assembly], // Stellar
            shared);
    }
}
